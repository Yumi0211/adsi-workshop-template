        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 text-sm">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-3 py-2 text-left font-medium text-gray-500">社員コード</th>
                ...
                <th className="px-3 py-2 text-left font-medium text-gray-500">ロール</th>
                <th className="px-3 py-2 text-left font-medium text-gray-500">部門</th>
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="社員登録">
        <div className="space-y-4">
          <div className="flex flex-col gap-1">
            <label htmlFor="emp-code" className="text-sm font-medium text-gray-700">社員コード</label>
            <input
              id="emp-code"
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="emp-name" className="text-sm font-medium text-gray-700">氏名</label>
            <input
              id="emp-name"
              type="text"
              value={form.name}
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="emp-email" className="text-sm font-medium text-gray-700">メール</label>
            <input
              id="emp-email"
              type="email"
              value={form.email}
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="emp-role" className="text-sm font-medium text-gray-700">ロール</label>
            <select
              id="emp-role"
              value={form.role}
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="emp-hire-date" className="text-sm font-medium text-gray-700">入社日</label>
            <input
              id="emp-hire-date"
              type="date"
              value={form.hireDate}
